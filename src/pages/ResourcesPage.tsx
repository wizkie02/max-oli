  ...
  const resources = [
    {
      ...
      description:
        "Printable templates to help children understand daily routines and transitions.",
    ...
    },
    {
      ...
      title: "Emotion Cards",
      description:
        "Illustrated cards to help children identify and express their feelings.",
    ...
    },
    {
      ...
      description:
        "Activities designed to help children regulate sensory input and maintain focus.",
    ...
    },
    {
      ...
      title: "Focus Timers",
      description:
        "Visual timers that make time management concrete and understandable.",
      categories: ["parents", "teachers", "children", "visual"],
      imageUrl: "/placeholder-image.jpg",
    ...
    },
    {
      ...
      description:
        "Customizable reward charts and token systems to encourage positive behaviors.",
    ...
    },
    {
      ...
      description:
        "Short narratives that explain social situations and appropriate responses.",
    ...
    },
    {
      ...
      description:
        "Activities designed to strengthen planning, organization, and self-monitoring skills.",
      categories: ["parents", "teachers", "children"],
      imageUrl: "/placeholder-image.jpg",
    ...
    },
    {
      ...
      description:
        "Tools to help children with attention challenges stay engaged with reading material.",
      categories: ["parents", "teachers", "children"],
      imageUrl: "/placeholder-image.jpg",
    ...
    },
    {
      ...
      description:
        "Resources that make abstract mathematical concepts more concrete and accessible.",
      categories: ["parents", "teachers", "children", "visual"],
      imageUrl: "/placeholder-image.jpg",
      ...
      <section className="py-12 md:py-20 bg-gradient-to-r from-[#67AAF9] to-[#1C4473]">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white max-w-3xl mx-auto">
            Practical tools and materials designed to support neurodivergent
